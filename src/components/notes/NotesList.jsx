...
export const NotesList = () => {
  ...
  return (
    <div className="min-h-screen p-4 sm:p-8 dark:bg-gray-900 bg-gradient-to-br from-pink-100 via-white to-pink-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 transition-colors duration-700">
      <DarkModeToggle />
